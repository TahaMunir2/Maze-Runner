...
HD_PWD='C:/Users/shold/Desktop/EIE-Y2/ghost_new_ip/ghost_game/ghost_game.runs/ghost_bd_gpio_rover_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ghost_bd_gpio_rover_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ghost_bd_gpio_rover_0.tcl
