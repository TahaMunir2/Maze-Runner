...
HD_PWD='C:/Users/shold/Desktop/EIE-Y2/ghost_new_ip/ghost_game/ghost_game.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ghost_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ghost_bd_wrapper.tcl -notrace
