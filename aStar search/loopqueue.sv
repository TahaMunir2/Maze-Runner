module loopQueue #(
    ...
    always_ff @(posedge clk) begin
        if(rst) begin
            ...
            if(packet_N_in[DATA_WIDTH-1:DATA_WIDTH-CELL_WIDTH] == end_cell || packet_E_in[DATA_WIDTH-1:DATA_WIDTH-CELL_WIDTH] == end_cell || packet_S_in[DATA_WIDTH-1:DATA_WIDTH-CELL_WIDTH] == end_cell || packet_W_in[DATA_WIDTH-1:DATA_WIDTH-CELL_WIDTH] == end_cell) begin
                cell_out <= end_cell;
