module backtrace #(
    ...
    input  logic [G_SCORE_WIDTH-1:0]  g_score_table [0:MAZE_COLS*MAZE_ROWS-1], // 2D array representing g-scores of each cell
    ...
    localparam logic [CELL_ROW_WIDTH-1:0] END_ROW = 4'd0;
    localparam logic [CELL_COLUMN_WIDTH-1:0] END_COL = 4'd9;

    // Internal state
    logic [CELL_ROW_WIDTH-1:0] cur_row;
    logic [CELL_COLUMN_WIDTH-1:0] cur_col;
    logic [G_SCORE_WIDTH-1:0] cur_g;
    logic [6:0] write_ptr;
